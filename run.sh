...
ls -alh
echo begin
python3 main.py --epocs 100 --dataset $1 --lear_rate 0.05 --batch_size 32
...
python3 main.py --epocs 100 --dataset $1 --version _norm --lear_rate 0.05 --batch_size 32
...
python3 main.py --epocs 100 --dataset $1 --version _sample --lear_rate 0.05 --batch_size 32
...
python3 main.py --epocs 100 --dataset $1 --version _sample_norm --lear_rate 0.05 --batch_size 32
