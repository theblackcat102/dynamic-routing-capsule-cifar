...
ls -alh
echo begin
python3 main.py --epocs 100 --dataset $1 --lear_rate 0.001 --batch_size 16
...
python3 main.py --epocs 100 --dataset $1 --has 0 --lear_rate 0.001 --batch_size 16
...
python3 main.py --epocs 100 --dataset $1 --version _norm --lear_rate 0.001 --batch_size 16
...
python3 main.py --epocs 100 --dataset $1 --has 0 --version _norm --lear_rate 0.001 --batch_size 16
...
python3 main.py --epocs 100 --dataset $1 --version _sample --lear_rate 0.001 --batch_size 16
...
python3 main.py --epocs 100 --dataset $1 --has 0 --version _sample --lear_rate 0.001 --batch_size 16
...
python3 main.py --epocs 100 --dataset $1 --version _sample_norm --lear_rate 0.001 --batch_size 16
...
python3 main.py --epocs 100 --dataset $1 --has 0 --version _sample_norm --lear_rate 0.001 --batch_size 16
